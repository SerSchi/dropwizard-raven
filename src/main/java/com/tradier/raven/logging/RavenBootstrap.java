...
public final class RavenBootstrap {
     ...
     * @param cleanRootLogger If true, detach and stop all other appenders from the root logger
     */
    public static void bootstrap(final String dsn, final Optional<String> tags, final boolean cleanRootLogger) {
     ...
     * @param dsn The DSN (Data Source Name) for your project
     * @param cleanRootLogger If true, detach and stop all other appenders from the root logger
     * @param raven Factory for RavenAppander
     */
    private static void registerAppender(
            final String dsn,
            final boolean cleanRootLogger,
            final RavenAppenderFactory raven
    ) {
        ...
        root.addAppender(
                raven.build(root.getLoggerContext(), dsn, layoutFactory, levelFilterFactory, asyncAppenderFactory));
    }
}
